...
For v7.7.1, Modes 0–29 reproduce v7.7 r1 exactly (switch `Transport Construction Materials Enabled` = 0) and Modes 30–31 own the new behaviour. Exact means bit-exact **on the canonical platform** (§8).
