...
| A Electronics Construction Materials per Capacity | constant | 12 | [calib] physical-material norm, value 12. | Scales Electronics Construction Materials demand and sink flow. | Order-of-magnitude matched to Capital Goods norm 11.5 per spec; candidate run checks consequences. |
...
| B Electronics Construction Materials per Capacity | constant | 12 | [calib] physical-material norm, value 12. | Scales Electronics Construction Materials demand and sink flow. | Order-of-magnitude matched to Capital Goods norm 11.5 per spec; candidate run checks consequences. |
...
| A Refinery Construction Materials per Capacity | constant | 20 | [calib] physical-material norm, value 20. | Scales Refinery Construction Materials demand and sink flow. | Order-of-magnitude matched to Capital Goods norm 17 per spec; candidate run checks consequences. |
...
| B Refinery Construction Materials per Capacity | constant | 20 | [calib] physical-material norm, value 20. | Scales Refinery Construction Materials demand and sink flow. | Order-of-magnitude matched to Capital Goods norm 17 per spec; candidate run checks consequences. |
...
| A Electronics Construction Materials per Capacity | constant | A | 12 | = | [calib] Construction Materials consumed per unit of new A Electronics installed capacity. | ✓ |
...
| B Electronics Construction Materials per Capacity | constant | B | 12 | = | [calib] Construction Materials consumed per unit of new B Electronics installed capacity. | ✓ |
...
| A Refinery Construction Materials per Capacity | constant | A | 20 | = | [calib] Construction Materials consumed per unit of new A Refinery installed capacity. | ✓ |
...
| B Refinery Construction Materials per Capacity | constant | B | 20 | = | [calib] Construction Materials consumed per unit of new B Refinery installed capacity. | ✓ |
...
| A Power Construction Materials per Capacity | constant | A | 1 | = | [calib] Construction Materials consumed per unit of new A Power installed generation capital. | ✓ |
...
| B Power Construction Materials per Capacity | constant | B | 1 | = | [calib] Construction Materials consumed per unit of new B Power installed generation capital. | ✓ |
...
| v7.7 Construction Materials Shock Multiplier | test_wiring | global | 0.1 |  | [calib] Mode 28 test-only multiplier applied to selected colony Construction Materials production capacity. | ✓ |
| v7.7 Regolith Shock Multiplier | test_wiring | global | 0.1 |  | [calib] Mode 29 test-only multiplier applied to selected colony Regolith extraction capacity. | ✓ |
